...
struct PluginVersionTests {
    ...
    @Test("Initialize from string")
    func testInitFromString() {
        let v = PluginVersion(description: "1.2.3")!
        #expect(v.major == 1)
        #expect(v.minor == 2)
        #expect(v.patch == 3)
    }
    ...
    func testPrerelease() {
        let v = PluginVersion(description: "1.2.3-beta.1")!
    ...
    func testBuildMetadata() {
        let v = PluginVersion(description: "1.2.3+build.123")!
...
struct AnyCodableTests {
    ...
    func testEncodeUnsupported() throws {
        struct Unsupported {}
...
struct CircuitBreakerTests {
    ...
    func testSuccessStaysClosed() async throws {
        let breaker = CircuitBreaker(failureThreshold: 3, successThreshold: 2, resetTimeout: 0.1)
    ...
    func testFailureIncrementsCount() async throws {
        let breaker = CircuitBreaker(failureThreshold: 3, successThreshold: 2, resetTimeout: 0.1)
        do {
    ...
    func testThrowsWhenOpen() async throws {
...
struct EffectTests {
    ...
    func testEffectCreateAndDispose() {
