...
## 七、质量基线（已实测，供核对）
- **当前基线（2026-08-26 周末覆盖审计轮 17，四门禁全绿 @c49c6e6）**：pr 门禁 SPM 790/790（Swift Testing 172 suites，/tmp/ci_pr_agent17.log）+ xcode 7-bundle swift-testing 353 + XCTest 131（per-bundle 口径，/tmp/ci_xcode_agent17.log）+ main 门禁（Release + 全量 + 覆盖率，干净口径：核心 14 包 98.86%（7037/7118）均 ≥90% / 18 包全量 96.36%（9602/9965）/ Agent 100% / core14 未覆盖 81 行全定性，/tmp/ci_main_agent17.log）+ leaks 门禁（MemProbe 500 → **0 leaks**，/tmp/ci_leaks_agent17.log）+ xcode 门禁（**TEST SUCCEEDED** 7 bundle，/tmp/ci_xcode_agent17.log）；前轮基线：968/968（覆盖审计轮 16 /tmp/ci_pr_agent16.log）/ 966/966（轮 15 /tmp/ci_pr_agent15.log）/ 961/961（轮 14 /tmp/ci_pr_agent14.log）
